...
public class SkillIQLeadersAdapter extends RecyclerView.Adapter<SkillIQLeadersAdapter.ViewHolder>{
    ...
    private List<SkillIQLeadersModel> skillIQLeadersModels;
    private SkillIQLeadersModel skillIQLeadersModel;

    public SkillIQLeadersAdapter(Context context, List<SkillIQLeadersModel> skillIQLeadersModels) {
        this.context = context;
        this.skillIQLeadersModels = skillIQLeadersModels;
    }

    public class ViewHolder extends RecyclerView.ViewHolder{
        public TextView name, country, score;
        public ImageView badgeUrl;

        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            name = itemView.findViewById(R.id.learning_name);
            score = itemView.findViewById(R.id.learning_hours);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        skillIQLeadersModel = skillIQLeadersModels.get(position);
    ...
    public int getItemCount() {
        return skillIQLeadersModels.size();
    }
}
